...
do
    ...
    for routine in "routines/"*; do
        for benchmark in "benchmark_hamilton/generate."*; do #Using file extensions to denote instance size, since extracting extension is trivial in Linux
...
Running the $routine benchmark for --hamilton. 
$normal============================[Input]============================$gray
...
EOF
            ...
            run_project="python3 ../main.py --hamilton"
            ...
            #Save to .csv
            echo "$(basename $routine),$instance_size,$time" >> $(basename $routine)_30h_benchmark_time.csv
            echo "$(basename $routine),$instance_size,$mem" >> $(basename $routine)_30h_benchmark_memory.csv
...
Saved to $(basename $routine)_30h_benchmark_time.csv $(basename $routine)_30h_benchmark_memory.csv
