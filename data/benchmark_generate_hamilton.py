...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 3:
        print("Usage: python benchmark_generate_hamilton.py <start_exponent> <end_exponent>")
        sys.exit(1)
    try:
        ...
        print(f"Error: {e}")
        print("Usage: benchmark_generate_hamilton.py <start_exponent> <end_exponent>")
        sys.exit(1)

    # Directory where files will be saved
    directory = 'benchmark_hamilton'
